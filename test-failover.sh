...
notify "Failover: starting" "Стан до тесту:\n$STATUS_BEFORE\nДокументів: $DOCS_BEFORE" "info"

# --- зупиняємо primary ---
docker stop mongo-primary
notify "Failover: mongo-primary DOWN" "mongo-primary зупинено\nОчікуємо вибори нового лідера..." "warning"
...
notify "Failover: mongo-primary BACK" "mongo-primary повернувся\n\nФінальний стан:\n$STATUS_FINAL" "success"
